$(function(){
	...
	var mzPrevList = $(".mzPrevList ul").bxSlider({
		...
		onSlideAfter: function(){
			$(".mzPrevList").children("div").each(function(){
	...
	// 하천계곡(시그니처영역)  버튼 클릭 시 알림영역(내부 콘텐츠 포함) 표시
	$('.controllerTopToggle_valley a:eq(0)').on('click', function(){
		if($('.controllerTopToggle_valley a:eq(0)').hasClass('toggle')) {
			$('.toggleTop_valley').stop().slideUp(600);
			$('.controllerTopToggle_valley a:eq(0)').removeClass('toggle').text('하천계곡사진 보기')
			$('.controllerTopToggle_valley a:eq(0)').removeClass('current')
		}else {
			$('.toggleTop_valley2').stop().slideUp(600);
			$('.controllerTopToggle_valley a:eq(1)').removeClass('toggle').text('추진현황 보기')
			$('.controllerTopToggle_valley a:eq(1)').removeClass('current')
			$('.toggleTop_valley3').stop().slideUp(600);
			$('.controllerTopToggle_valley a:eq(2)').removeClass('toggle').text('소식/자료 보기')	
			$('.controllerTopToggle_valley a:eq(2)').removeClass('current')
			
			$('.toggleTop_valley').stop().slideDown(600);
			$('.controllerTopToggle_valley a:eq(0)').addClass('toggle').text('하천계곡사진 닫기')
			$('.controllerTopToggle_valley a:eq(0)').addClass('current')
		}
		return false;
	})
	
	$('.controllerTopToggle_valley a:eq(1)').on('click', function(){
		if($('.controllerTopToggle_valley a:eq(1)').hasClass('toggle')) {
			$('.toggleTop_valley2').stop().slideUp(600);
			$('.controllerTopToggle_valley a:eq(1)').removeClass('toggle').text('추진현황 보기')
			$('.controllerTopToggle_valley a:eq(1)').removeClass('current')
		}else {
			...
			$('.toggleTop_valley2').stop().slideDown(600);			
			$('.controllerTopToggle_valley a:eq(1)').addClass('toggle').text('추진현황 닫기')
			$('.controllerTopToggle_valley a:eq(1)').addClass('current')
		}
		return false;
	})
	
	$('.controllerTopToggle_valley a:eq(2)').on('click', function(){
		if($('.controllerTopToggle_valley a:eq(2)').hasClass('toggle')) {
			$('.toggleTop_valley3').stop().slideUp(600);
			$('.controllerTopToggle_valley a:eq(2)').removeClass('toggle').text('소식/자료 보기')
			$('.controllerTopToggle_valley a:eq(2)').removeClass('current')
		}else {
			...
			$('.toggleTop_valley3').stop().slideDown(600);
			$('.controllerTopToggle_valley a:eq(2)').addClass('toggle').text('소식/자료 닫기')
			$('.controllerTopToggle_valley a:eq(2)').addClass('current')
		}
		return false;
	})

})
/*function openPop_valley() {
	if($('.controllerTopToggle_valley a:eq(0)').hasClass('toggle')) {
		$('.toggleTop_valley').stop().slideUp(600);
		$('.controllerTopToggle_valley a:eq(0)').removeClass('toggle').text('하천계곡사진 보기')
	}else {
